 ...
 */
final class Version20240327171828 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE movie_salle (movie_id INT NOT NULL, salle_id INT NOT NULL, INDEX IDX_30D564C08F93B6FC (movie_id), INDEX IDX_30D564C0DC304035 (salle_id), PRIMARY KEY(movie_id, salle_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
